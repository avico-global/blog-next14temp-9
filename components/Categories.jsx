...
export default function Categories({ categories, imagePath }) {
  ...
  return (
    <>
      <div
        className="left-0 top-full rounded-md z-50 w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 min-h-[200px] sm:min-h-[300px] transition-all duration-1000"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.2)), url(${imagePath}/${
            bgImage || categories[0]?.image
          })`,
